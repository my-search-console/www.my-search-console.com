    ...
    >
      <div
        className={classNames(
          ...
          props.type === "clicks" && "ring-pink-300",
          props.type === "impressions" && "ring-fuchsia-300",
          props.type === "position" && "ring-amber-300",
          props.type === "click_through_rate" && "ring-sky-300"
        )}
      >
        ...
        <div onClick={props.onClick} className="h-full w-full p-4">
          <div>
            <dt className="text-sm font-medium leading-tight text-slate-900">
              <FormattedMessage
                id={`analytics/histogram/filter/${props.type}`}
              />
            </dt>
            <dd className="items-center justify-between sm:flex">
              <div
                className={classNames(
                  ...
                  props.type === "clicks" && "text-pink-400",
                  props.type === "impressions" && "text-fuchsia-400"
                )}
              >
...
export const Wrapper: React.FC<{
  ...
  const selected = search.searchParams.get("orderBy") || "clicks"

  return (
    <div className="m-auto w-full font-display">
      <dl className="mb-4 grid grid-cols-2 gap-4 lg:grid-cols-2">
        <Item
