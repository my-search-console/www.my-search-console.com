      ...
      <Container>
        <div className="py-16">
          ...
          <nav className="mt-10 text-sm" aria-label="quick links">
            <div className="-my-1 flex flex-wrap justify-center gap-x-6">
              ...
              <a
                href="https://foudroyer.tolt.io/"
                className="inline-flex h-10 items-center rounded-md px-4 font-display text-sm font-semibold transition duration-300 ease-in-out hover:bg-pink-50 hover:text-pink-400 focus:outline-none focus:ring-2 focus:ring-offset-2"
                target="_blank"
              >
                ...
                <span className="ml-2 inline-flex items-center rounded-full bg-pink-100 px-2.5 py-0.5 text-xs font-medium text-pink-800">
                  <FormattedMessage id="footer/affiliate/badge"></FormattedMessage>
                </span>
              </a>
            </div>
          </nav>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} Foudroyer. All rights
            reserved.
          </p>
        </div>
      </Container>
