          ...
          <nav className="mt-10 text-sm" aria-label="quick links">
            ...
            <div className="flex flex-wrap justify-center gap-x-6">
              ...
              <NavLink
                ...
                href="https://trello.com/b/RdGyP7pZ/my-search-console-road-map"
              >
                Road Map
              </NavLink>
              <NavLink
                target="_blank"
                rel="noopener noreferrer nofollow"
                href="https://msc.featurebase.app"
              >
                Feature Requests
              </NavLink>
              <NavLink
                target="_blank"
                rel="noopener noreferrer nofollow"
                href="https://plausible.my-search-console.com/my-search-console.com"
              >
                Statistics
              </NavLink>
            </div>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex items-center gap-x-6">
            ...
            <a
              ...
              rel="noopener noreferrer nofollow"
            >
              <FaGithub className="h-6 w-6 fill-slate-500 group-hover:fill-slate-900" />
            </a>
