  ...
  return (
    <div className="relative">
      ...
      <Container className="flex flex-col items-center justify-center  pb-10 pt-20 text-center">
        ...
        <h1 className="mx-auto flex max-w-6xl flex-col font-display text-5xl font-semibold leading-tight tracking-tight text-slate-900 ">
          {props.title}
        </h1>
        ...
        {props.description && (
          <ReactMarkdown
            className={
              "mx-auto mt-4 max-w-3xl text-lg leading-normal tracking-tight text-slate-900"
            }
          >
            {props.description}
          </ReactMarkdown>
