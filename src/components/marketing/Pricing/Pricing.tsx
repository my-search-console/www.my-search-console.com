...
import { connector } from "./containers/Pricing.containers"
import {
  connector as connectorLanding,
  ContainerProps as ContainerPropsLanding,
      ...
      <div className="max-w-9xl mx-auto overflow-hidden px-6 pb-80 pt-24 text-center lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <h2 className="mt-2 font-display text-4xl font-semibold tracking-tight sm:text-5xl">
            {(!props.source ||
              (props.source !== "indexation/quota" &&
                props.source !== "indexation/report" &&
                props.source !== "indexation/trial-expired" &&
                props.source !== "indexation/add-website")) && (
              <FormattedMessage id={tiers[0].title} />
            )}
            {props.source === "indexation/add-website" && (
      ...
      <div className="mt-12 flow-root bg-white pb-8">
        <div className="-mt-80">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-4 grid max-w-md grid-cols-1 gap-8 lg:max-w-7xl lg:grid-cols-3">
              {tiers.map((tier, tierIndex) => (
                <div
                  key={tierIndex}
                  className={classNames(
                    "relative flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-slate-200 sm:p-10",
                    tier.highlight && "ring-4 !ring-pink-300"
                  )}
                >
                  {
                    // @ts-ignore
              ...
              <div className="flex flex-col items-start gap-x-8 gap-y-6 rounded-3xl bg-white p-8 ring-1 ring-slate-200 sm:gap-y-10 sm:p-10 lg:col-span-3 lg:flex-row lg:items-center">
...
const Connected: React.FC<ContainerPropsLanding> = (props) => (
  <Wrapper {...props} />
)
export const Pricing = connector(Connected)

const ConnectedLanding: React.FC<ContainerPropsLanding> = (props) => (
  <Wrapper {...props} />
)
export const PricingLanding = connectorLanding(ConnectedLanding)
