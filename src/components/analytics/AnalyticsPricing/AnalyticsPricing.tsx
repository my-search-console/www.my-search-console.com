...
import {
  connector,
  ContainerProps,
} from "./containers/AnalyticsPricing.container"
...
import { PricingSwitchBillingInterval } from "../../marketing/Pricing/components/PricingSwitchBillingInterval"
...
const tiers: Array<{
  ...
  {
    name: "marketing/pricing/analytics/free/label",
    id: "tier-hobby",
    priceMonthly: 0,
    plan: PaymentPlansEntity["analytics/free"],
  ...
  {
    name: "marketing/pricing/analytics/beginner/label",
    id: "starter",
    priceMonthly: 9,
  ...
  {
    name: "marketing/pricing/analytics/pro/label",
    id: "professional",
  ...
  {
    name: "marketing/pricing/analytics/enterprise/label",
    id: "enterprise",
...
export const Wrapper: React.FC<Props> = (props) => {
  ...
  const needUpgrade = location.href?.includes("need-upgrade")
      ...
      <div className="max-w-9xl mx-auto overflow-hidden px-6 pb-80 pt-24 text-center lg:px-8">
        <div className="mx-auto max-w-5xl">
          <span className="font-display text-base font-semibold text-pink-400">
            <FormattedMessage id={"pricing/analytics/label"} />
          </span>
          <h2 className="mt-2 font-display text-4xl font-semibold tracking-tight sm:text-5xl">
            {!needUpgrade && (
              <FormattedMessage id={"pricing/analytics/title"} />
            )}

            {needUpgrade && (
              <FormattedMessage id={"pricing/analytics/title/need-upgrade"} />
            )}
          </h2>
        </div>
        ...
        <div className="relative mt-4">
          <p className="mx-auto max-w-2xl text-lg leading-8 text-slate-700">
            {!needUpgrade && (
              <FormattedMessage id={`pricing/analytics/description`} />
            )}

            {needUpgrade && (
              <FormattedMessage
                id={"pricing/analytics/description/need-upgrade"}
              />
            )}
          </p>
      ...
      <div className="mt-12 flow-root bg-white pb-8">
        <div className="-mt-80">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-4 grid max-w-md grid-cols-1 gap-4 lg:max-w-7xl lg:grid-cols-4">
              {tiers.map((tier, tierIndex) => (
                <div
                  key={tierIndex}
                  className={classNames(
                    "relative flex flex-col justify-between rounded-3xl bg-white p-6 ring-1 ring-slate-200 sm:p-6",
                    tier.plan === props.actualPlan && "ring-2 !ring-pink-400"
                  )}
                >
                  {tier.plan === props.actualPlan && (
                  ...
                  <div>
                    ...
                    <div className="flex items-baseline gap-x-2">
                      ...
                      >
                        {props.products[tier.plan][interval] || 0}
                      ...
                      <span className="font-display text-base font-semibold leading-7 text-slate-400">
                        ...
                        {interval === "yearly" && (
                          <FormattedMessage id="marketing/pricing/per-year" />
                        )}
                      </span>
                    </div>
                  ...
                  <div className="mt-8">
                    <ButtonPrimary
                      ...
                      fullWidth
                    >
                      {tier.plan === PaymentPlansEntity["analytics/free"] && (
...
export const AnalyticsPricing = connector(Connected)
