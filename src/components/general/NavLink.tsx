...
export const NavLink: React.FC<{
  ...
  return (
    <FoudroyerLink
      ...
      target={props.target}
      className={clsx(
        "inline-flex cursor-pointer h-10 items-center rounded-md px-4 font-display text-sm font-semibold transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2",
