  ...
  return (
    ...
    >
      <div className="text-center">
        <svg
          aria-hidden="true"
          className="mr-2 inline-block h-10 w-10 animate-spin fill-pink-500 text-slate-200 "
          viewBox="0 0 100 101"
          fill="none"
        ...
        {props.additionnalText ? (
          <p className="mt-4 rounded p-1 px-2 font-display text-sm">
            {props.additionnalText}
          </p>
        ) : null}
      </div>
